...
public class MVPKit extends Kits {
	
	public MVPKit() {
		super("MVP", 600, true, 600);
	...
	public ItemStack getIcon() {
		...
		hMeta.setDisplayName(ColorText.translate("&dMVP Kit"));
	...
	public ItemStack[] getArmor() {
		...
		hMeta.setDisplayName(ColorText.translate("&dMVP Helmet"));
		hMeta.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 3, true);
		hMeta.addEnchant(Enchantment.PROTECTION_FIRE, 1, true);
		...
		cMeta.setDisplayName(ColorText.translate("&dMVP Chestplate"));
		cMeta.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 3, true);
		cMeta.addEnchant(Enchantment.PROTECTION_FIRE, 1, true);
		...
		lMeta.setDisplayName(ColorText.translate("&dMVP Leggings"));
		lMeta.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 3, true);
		lMeta.addEnchant(Enchantment.PROTECTION_FIRE, 1, true);
		...
		bMeta.setDisplayName(ColorText.translate("&dMVP Boots"));
		bMeta.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 3, true);
		bMeta.addEnchant(Enchantment.PROTECTION_FIRE, 1, true);
	...
	public ItemStack[] getItems() {
		...
		vMeta.setDisplayName(ColorText.translate("&dMVP Sword"));
		...
		sMeta.setDisplayName(ColorText.translate("&dMVP Bow"));
	    ...
	    ItemStack healing = new ItemStack(Material.POTION, 6, (short)16389);
	    PotionMeta pMeta = (PotionMeta) healing.getItemMeta();
	    pMeta.setMainEffect(PotionEffectType.HEAL);
	  	healing.setItemMeta(pMeta);
	  	stack[4] = healing;
	  	
	    ItemStack stren = new ItemStack(Material.POTION, 6, (short)16393);
