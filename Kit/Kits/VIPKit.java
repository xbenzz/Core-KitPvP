...
public class VIPKit extends Kits {
	
	public VIPKit() {
		super("VIP", 200, true, 600);
	...
	public ItemStack getIcon() {
		...
		hMeta.setDisplayName(ColorText.translate("&aVIP Kit"));
	...
	public ItemStack[] getArmor() {
		...
		hMeta.setDisplayName(ColorText.translate("&aVIP Helmet"));
		...
		cMeta.setDisplayName(ColorText.translate("&aVIP Chestplate"));
		...
		lMeta.setDisplayName(ColorText.translate("&aVIP Leggings"));
		...
		bMeta.setDisplayName(ColorText.translate("&aVIP Boots"));
		bMeta.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 2, true);
	...
	public ItemStack[] getItems() {
		...
		vMeta.setDisplayName(ColorText.translate("&aVIP Sword"));
		vMeta.addEnchant(Enchantment.DAMAGE_ALL, 3, true);
		...
		sMeta.setDisplayName(ColorText.translate("&aVIP Bow"));
	    ...
	    ItemStack healing = new ItemStack(Material.POTION, 2, (short)16389);
	    PotionMeta pMeta = (PotionMeta) healing.getItemMeta();
	    pMeta.setMainEffect(PotionEffectType.HEAL);
	  	healing.setItemMeta(pMeta);
	  	stack[4] = healing;
	  	
	    ItemStack stren = new ItemStack(Material.POTION, 2, (short)16393);
